        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <a href="{{ route('medewerker.tickets.index') }}" class="block p-6 bg-green-100 hover:bg-green-200 rounded-lg shadow transition">
                        <h3 class="text-lg font-semibold">Tickets</h3>
                        <p class="text-sm text-gray-700">Bekijk en beheer tickets.</p>
                    </a>
                    
                    <a href="{{ route('medewerker.tickets.scanner') }}" class="block p-6 bg-indigo-100 hover:bg-indigo-200 rounded-lg shadow transition">
                        <h3 class="text-lg font-semibold">Ticket Scanner</h3>
                        <p class="text-sm text-gray-700">Scan en verifieer tickets.</p>
                    </a>
