...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => $dashboardRoute,'active' => request()->routeIs('admin.dashboard') || request()->routeIs('medewerker.dashboard')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($dashboardRoute),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('admin.dashboard') || request()->routeIs('medewerker.dashboard'))]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => $dashboardRoute,'active' => request()->routeIs('admin.dashboard') || request()->routeIs('medewerker.dashboard')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH /Users/hernanmartinomolina/Desktop/Aurora Project Periode 4/aurora/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>